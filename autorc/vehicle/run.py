...
class AutoRC(threading.Thread):
    ...
    def __init__(self):
        ...
        self.cerebellum = CerebellumSelect("ADVANCED", update_interval_ms=50, controller=self.controller, cortex=self.cortex, corti=self.corti, model_name="One_Hot_Tests")
